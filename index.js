...
//==========================================================
// //import express
// const express = require("express"); //we do not need to write a path here
// //create a server
// const server = express(); //get an instanse of  a server
// const shortid = require("shortid");
...
// //collection of hubs: must be let!!!!
// // let hubs = [
// //   {
// //     id: 1,
// //     name: "building apis with express", //the name of today lesson
// //     lessonId: 1,
// //     cohort: "web 15",
// //   },
// //   {
// //     id: 2,
// //     name: "server routing with express", //the name of tomorrow lesson
// //     lessonId: 2,
// //     cohort: "web 15",
// //   },
// // ];
...
// //Update - change, a little changes
// server.patch("/api/hubs/:id", (req, res) => {
//   const { id } = req.params;
//   const changes = req.body;
//   let found = hubs.find((hub) => hub.id === id);
...
//   //axios.post(url, data, oprions)-> the data is in the request body
//   const hub = req.body; //read the data from the body
//   hubs.push(hub); //add that data to collection
//   res.status(201).json(hubs); //201 when created, return the collection
// });
// //create a new lesson
// server.post("/lessons", function (req, res) {
//   //axios.post(url, data, oprions)-> the data is in the request body
//   const lesson = req.body; //read the data from the body
//   lessons.push(lesson); //add that data to collection
//   res.status(201).json(lessons); //201 when created, return the collection
// });

// //delete
// server.delete("/hubs/:hubid", function (req, res) {
//   const id = req.params.hubid; //id is a string, but in hubs it is a number
